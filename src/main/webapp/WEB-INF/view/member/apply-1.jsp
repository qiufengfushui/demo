...
<div class="container theme-showcase" role="main">
    ...
    <form role="form" style="margin-top:20px;">
        <div class="form-group">
            <label for="file">手执身份证照片</label>
            <input type="file" class="form-control"id="file" >
            <br>
            <img src="${APP_Path}/statics/img/pic.jpg">
        </div>
        <button type="button" onclick="window.location.href='${APP_Path}/apply'" class="btn btn-default">上一步</button>
        <button type="button" onclick="window.location.href='${APP_Path}/apply-2'"  class="btn btn-success">下一步</button>
    </form>
    <hr>
</div> <!-- /container -->
