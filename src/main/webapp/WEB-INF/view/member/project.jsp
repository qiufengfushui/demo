                ...
                <nav class="navbar navbar-default" role="navigation">
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav">
                            ...
                            <li >
                                <a rel="nofollow" href="${APP_Path}/projects"><i class="glyphicon glyphicon-th-large"></i> 众筹项目</a>
                            </li>
                            <li>
            ...
            <div class="col-md-12 column">
                <div class="row clearfix">
                    <div class="col-md-8 column">
                        <img alt="140x140" width="740" src="${APP_Path}/statics/img/product_detail_head.jpg" />
                        <img alt="140x140" width="740" src="${APP_Path}/statics/img/product_detail_body.jpg" />
                    ...
                    <div class="col-md-4 column">
                                ...
                                <div class="container-fluid">
                                    <div class="row clearfix">
                                        <div class="col-md-3 column" style="padding:0;">
                                            <img alt="140x140" src="${APP_Path}/statics/img/services-box2.jpg" data-holder-rendered="true" style="width: 80px; height: 80px;">
                                        </div>
                        ...
                        <div class="prjtip panel panel-default" style="border-radius: 0px;">
                            <div class="panel-body">
                                <img src="${APP_Path}/statics/img/product-3.png" width="100%" height="100%">
                            </div>
                        </div>

                        <div class="prjtip panel panel-default" style="border-radius: 0px;">
                            <div class="panel-body">
                                <img src="${APP_Path}/statics/img/product-4.jpg" width="100%" height="100%">
                            </div>
                        </div>
                    </div>
                </div>
