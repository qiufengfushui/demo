...
<head>
    ...
    <link rel="stylesheet" href="${APP_Path}/statics/css/carousel.css">
    <style>
        h3 {
            font-weight:bold;
        }
            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse" style="float:right;">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="${APP_Path}/reg">注册</a></li>
                    </ul>
                </div>
            </div>
        </nav>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active" onclick="window.location.href='${APP_Path}/project'" style="cursor:pointer;">
            <img src="${APP_Path}/statics/img/carousel-1.jpg" alt="First slide">
        </div>
        <div class="item" onclick="window.location.href='${APP_Path}/project'" style="cursor:pointer;">
            <img src="${APP_Path}/statics/img/carousel-2.jpg" alt="Second slide">
        </div>
        <div class="item" onclick="window.location.href='${APP_Path}/project'" style="cursor:pointer;">
            <img src="${APP_Path}/statics/img/carousel-3.jpg" alt="Third slide">
        </div>
    </div>
...
<div class="container marketing">
    ...
    <div class="row">
        <div class="col-lg-4">
            <img class="img-circle" src="${APP_Path}/statics/img/p1.jpg" alt="Generic placeholder image" style="width: 140px; height: 140px;">
            <h2>智能高清监控机器人</h2>
            <p>可爱的造型，摄像安防远程互联的全能设计，让你随时随地守护您的家人，陪伴你的生活。</p>
            <p><a class="btn btn-default" href="${APP_Path}/project" role="button">项目详情 &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
            <img class="img-circle" src="${APP_Path}/statics/img/p2.jpg" alt="Generic placeholder image" style="width: 140px; height: 140px;">
            <h2>NEOKA智能手环</h2>
            <p>要运动更要安全，这款、名为“蝶舞”的NEOKA-V9100智能运动手环为“安全运动而生”。</p>
            <p><a class="btn btn-default" href="${APP_Path}/project" role="button">项目详情 &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
            <img class="img-circle" src="${APP_Path}/statics/img/p3.png" alt="Generic placeholder image" style="width: 140px; height: 140px;">
            <h2>驱蚊扣</h2>
                ...
                <div class="box ui-draggable" id="mainBox">
                    ...
                    <div class="mBd" style="padding-top:10px;">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="thumbnail">
                                    <img alt="300x200" src="${APP_Path}/statics/img/product-1.jpg" />
                                    <div class="caption">
                                        <h3 class="break">
                                            <a href="${APP_Path}/project">活性富氢净水直饮机</a>
                                        </h3>
                                        <p>
                            ...
                            <div class="col-md-3">
                                <div class="thumbnail">
                                    <img alt="300x200" src="${APP_Path}/statics/img/product-2.gif" />
                                    <div class="caption">
                                        <h3 class="break">
                                            <a href="${APP_Path}/project">酷驰触控龙头，智享厨房黑科技</a>
                                        </h3>
                                        <p>
                                        <div style="float:left;"><i class="glyphicon glyphicon-screenshot" title="目标金额" ></i> $20,000 </div>
                                        <div style="float:right;"><i title="截至日期" class="glyphicon glyphicon-calendar"></i> 2017-20-20 </div>
                            ...
                            <div class="col-md-3">
                                <div class="thumbnail">
                                    <img alt="300x200" src="${APP_Path}/statics/img/product-3.png" />
                                    <div class="caption">
                                        <h3 class="break">
                                            <a href="${APP_Path}/project">小熊猫鱼眼全景安防摄像机</a>
                                        </h3>
                                        <p>
                                        <div style="float:left;"><i class="glyphicon glyphicon-screenshot" title="目标金额" ></i> $20,000 </div>
                                        <div style="float:right;"><i title="截至日期" class="glyphicon glyphicon-calendar"></i> 2017-20-20 </div>
                            ...
                            <div class="col-md-3">
                                <div class="thumbnail">
                                    <img alt="300x200" src="${APP_Path}/statics/img/product-4.jpg" />
                                    <div class="caption">
                                        <h3 class="break">
                                            <a href="${APP_Path}/project">一款精致的机械表</a>
                                        </h3>
                                        <p>
                                        <div style="float:left;"><i class="glyphicon glyphicon-screenshot" title="目标金额" ></i> $20,000 </div>
                                        <div style="float:right;"><i title="截至日期" class="glyphicon glyphicon-calendar"></i> 2017-20-20 </div>
                ...
                <div class="box ui-draggable" id="mainBox">
                    ...
                    <div class="mBd" style="padding-top:10px;">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="thumbnail">
                                    <img alt="300x200" src="${APP_Path}/statics/img/product-5.jpg" />
                                    <div class="caption">
                                        <h3 class="break">
                                            <a href="${APP_Path}/project">活性富氢净水直饮机</a>
                                        </h3>
                            ...
                            <div class="col-md-3">
                                <div class="thumbnail">
                                    <img alt="300x200" src="${APP_Path}/statics/img/product-6.jpg" />
                                    <div class="caption">
                                        <h3 class="break">
                                            <a href="${APP_Path}/project">酷驰触控龙头，智享厨房黑科技</a>
                                        </h3>
                            ...
                            <div class="col-md-3">
                                <div class="thumbnail">
                                    <img alt="300x200" src="${APP_Path}/statics/img/product-7.jpg" />
                                    <div class="caption">
                                        <h3 class="break">
                                            <a href="${APP_Path}/project">小熊猫鱼眼全景安防摄像机</a>
                                        </h3>
                            ...
                            <div class="col-md-3">
                                <div class="thumbnail">
                                    <img alt="300x200" src="${APP_Path}/statics/img/product-8.jpg" />
                                    <div class="caption">
                                        <h3 class="break">
                                            <a href="${APP_Path}/project">一款精致的机械表</a>
                                        </h3>
                ...
                <div class="box ui-draggable" id="mainBox">
                    ...
                    <div class="mBd" style="padding-top:10px;">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="thumbnail">
                                    <img alt="300x200" src="${APP_Path}/statics/img/product-9.jpg" />
                                    <div class="caption">
                                        <h3 class="break">
                                            <a href="${APP_Path}/project">活性富氢净水直饮机</a>
                                        </h3>
...
<script>
    ...
    $(".thumbnail img").click(function(){
        window.location.href = "${APP_Path}/project";
    });
</script>
</body>
</html>
