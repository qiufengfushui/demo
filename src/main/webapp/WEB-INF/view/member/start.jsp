                    ...
                    <ul class="nav navbar-nav">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="${APP_Path}/member">会员中心</a></li>
                                <li><a href="${APP_Path}/message">消息 <span class="badge badge-success">42</span></a></li>
                                <li class="divider"></li>
                                <li><a href="${APP_Path}/index">退出系统</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
                ...
                <nav class="navbar navbar-default" role="navigation">
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav">
                            ...
                            <li >
                                <a rel="nofollow" href="${APP_Path}/projects"><i class="glyphicon glyphicon-th-large"></i> 项目总览</a>
                            </li>
                            <li class="active">
            ...
            <div class="col-md-12 column">
                <div class="panel panel-default" >
                    ...
                    <div class="panel-footer" style="text-align:center;">
                        <button type="button" class="btn  btn-warning btn-lg" onclick="window.location.href='${APP_Path}/start-step-1'">阅读并同意协议</button>
                    </div>
                </div>
            </div>
        </div>
