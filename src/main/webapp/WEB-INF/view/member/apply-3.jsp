...
<div class="container theme-showcase" role="main">
    ...
    <form role="form" style="margin-top:20px;">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="verification" placeholder="请输入你邮箱中接收到的验证码">
        </div>
        <button type="button" onclick="javascript:;" class="btn btn-primary">重新发送验证码</button>
        <button type="button" onclick="window.location.href='${APP_Path}/member'"  class="btn btn-success">申请完成</button>
    </form>
    <hr>
</div> <!-- /container -->
