 ...
 * Generated at: 2018-12-06 00:56:17 UTC
...
public final class user_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("                                <input class=\"form-control has-success\" type=\"text\" id=\"queryCondition\" name=\"queryCondition\" placeholder=\"请输入查询条件\">\r\n");
      out.write("                            </div>\r\n");
      out.write("                        </div>\r\n");
      out.write("                        <button type=\"button\" class=\"btn btn-warning\" id=\"query\"><i class=\"glyphicon glyphicon-search\"></i> 查询</button>\r\n");
      out.write("                    </form>\r\n");
      out.write("                    <button type=\"button\" class=\"btn btn-danger\" onclick=\"batchDelUser()\" style=\"float:right;margin-left:10px;\"><i class=\" glyphicon glyphicon-remove\"></i> 删除</button>\r\n");
      out.write("                    <button type=\"button\" class=\"btn btn-primary\" style=\"float:right;\" onclick=\"window.location.href='");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${APP_Path}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/add'\"><i class=\"glyphicon glyphicon-plus\"></i> 新增</button>\r\n");
      out.write("                    <br>\r\n");
      out.write("                    <hr style=\"clear:both;\">\r\n");
      out.write("                    <div class=\"table-responsive\">\r\n");
      out.write("                        <table class=\"table  table-bordered\" id=\"userList\">\r\n");
      out.write("                            <thead>\r\n");
      out.write("                            <tr>\r\n");
      out.write("                                <th width=\"30\">#</th>\r\n");
      out.write("                                <th width=\"30\"><input type=\"checkbox\" onclick=\"selector(this)\" ></th>\r\n");
      out.write("                                <th>账号</th>\r\n");
      out.write("                                <th>名称</th>\r\n");
      ...
      out.write("<script type=\"text/javascript\">\r\n");
      out.write("        //bug：第二次点的时候无响应\r\n");
      out.write("    function selector(element){\r\n");
      out.write("        if(element.checked){\r\n");
      out.write("            //全选\r\n");
      out.write("            /*$(\"#userInfo :checkbox\").attr(\"checked\",\"checked\");*/\r\n");
      out.write("            $(\"#userInfo :checkbox\").prop(\"checked\", true);\r\n");
      out.write("        }else {\r\n");
      out.write("            //全不选\r\n");
      out.write("            /*$(\"#userInfo :checkbox\").removeAttr(\"checked\");*/\r\n");
      out.write("            $(\"#userInfo :checkbox\").prop(\"checked\", false);\r\n");
      out.write("        }\r\n");
      out.write("    }\r\n");
      out.write("    $(function () {\r\n");
      out.write("        $(\"#query\").click(function () {\r\n");
      out.write("            var queryCondition = $(\"#queryCondition\").val()\r\n");
      out.write("            queryUser(1,queryCondition)\r\n");
      out.write("        })\r\n");
      out.write("    })\r\n");
      out.write("    function queryUser(pageNum,queryCondition){\r\n");
      out.write("        var data = {\r\n");
      out.write("            pageNum:pageNum,\r\n");
      out.write("            queryCondition:queryCondition\r\n");
      out.write("        }\r\n");
      out.write("        $.ajax({\r\n");
      out.write("            type : \"post\",\r\n");
      out.write("            url  : \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${APP_Path}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/doAJAXList\",\r\n");
      out.write("            data : data,\r\n");
      out.write("            dataType : \"json\",\r\n");
      out.write("            beforeSend:function () {\r\n");
      out.write("                layerIndex = layer.msg('加载中',{icon:16});\r\n");
      out.write("            },\r\n");
      out.write("            success:function (result) {\r\n");
      out.write("                layer.close(layerIndex)\r\n");
      out.write("                var userInfo = $(\"#userInfo\");      //用户信息\r\n");
      out.write("                var list = result.list\r\n");
      out.write("                var userContext = \"\";\r\n");
      out.write("                $(list).each(function (index,element) {\r\n");
      out.write("                    userContext += '<tr>'\r\n");
      out.write("                    userContext += '    <td>'+(index + 1)+'</td>'\r\n");
      out.write("                    userContext += '    <td><input type=\"checkbox\" value=\"'+element.id+'\"></td>'\r\n");
      out.write("                    userContext += '        <td>'+element.userCode+'</td>'\r\n");
      out.write("                    userContext += '        <td>'+element.userCode+'</td>'\r\n");
      out.write("                    userContext += '        <td>'+element.email+'</td>'\r\n");
      out.write("                    userContext += '        <td>'\r\n");
      out.write("                    userContext += '    <button type=\"button\" class=\"btn btn-success btn-xs\" onclick=\"look(this)\"    uid='+element.id+'> <i class=\" glyphicon glyphicon-check\"></i></button>'\r\n");
      out.write("                    userContext += '    <button type=\"button\" class=\"btn btn-primary btn-xs\" onclick=\"edit(this)\"  uid='+element.id+'><i class=\" glyphicon glyphicon-pencil\"></i></button>'\r\n");
      out.write("                    userContext += '    <button type=\"button\" class=\"btn btn-danger btn-xs\"  onclick=\"del(this)\"     uid='+element.id+'><i class=\" glyphicon glyphicon-remove\"></i></button>'\r\n");
      out.write("                    userContext += '    </td>'\r\n");
      out.write("                    userContext += '    </tr>'\r\n");
      out.write("                })\r\n");
      out.write("                userInfo.html(userContext)\r\n");
      out.write("                //分页内容\r\n");
      out.write("                var pageBean = result.pageBean\r\n");
      out.write("                var pageNum = pageBean.pageNum   //当前页码\r\n");
      out.write("                var totalPage = pageBean.totalPage   //当前页码\r\n");
      out.write("                var start = pageBean.start   //开始索引\r\n");
      out.write("                var end = pageBean.end   //结束索引\r\n");
      out.write("                var pag = \"\";\r\n");
      out.write("                pag += '<tr>'\r\n");
      out.write("                pag += '<td colspan=\"6\" align=\"center\">'\r\n");
      out.write("                pag += '    <ul class=\"pagination\">'\r\n");
      out.write("                if(pageNum == 1){\r\n");
      out.write("                    pag += '    <li class=\"disabled\"><a href=\"#\">上一页</a></li>'\r\n");
      out.write("                }else{\r\n");
      out.write("                    pag += '    <li><a href=\"javascript:;\" onclick=\"queryUser('+(pageNum-1)+')\">上一页</a></li>'\r\n");
      out.write("                }\r\n");
      out.write("                for (; start <= end; start++) {\r\n");
      out.write("                    if(pageNum == start ){\r\n");
      out.write("                        pag += '<li class=\"active\"><a href=\"#\">'+start+' <span class=\"sr-only\">(current)</span></a></li>'\r\n");
      out.write("                    }else{\r\n");
      out.write("                        pag += '<li><a href=\"javascript:;\" onclick=\"queryUser('+start+')\">'+start+'</a></li>'\r\n");
      out.write("                    }\r\n");
      out.write("                }\r\n");
      out.write("                if(totalPage > pageNum){\r\n");
      out.write("                    pag += '<li><a href=\"javascript:;\" onclick=\"queryUser('+(pageNum+1)+')\">下一页</a></li>'\r\n");
      out.write("                }else{\r\n");
      out.write("                    pag += '<li class=\"disabled\"><a href=\"#\">下一页</a></li>'\r\n");
      out.write("                }\r\n");
      out.write("                pag += '</ul>'\r\n");
      out.write("                pag += '</td>'\r\n");
      out.write("                pag += '</tr>'\r\n");
      out.write("                $(\"#paging\").html(pag)\r\n");
      ...
      out.write("    });\r\n");
      out.write("\r\n");
      out.write("    function look(element) {\r\n");
      out.write("        //查看\r\n");
      out.write("        window.location.href = \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${APP_Path}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/assignRole\";\r\n");
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    function edit(element) {\r\n");
      out.write("        //修改\r\n");
      out.write("        var obj = $(element);\r\n");
      out.write("        window.location.href = \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${APP_Path}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/edit?id=\"+obj.attr(\"uId\")+\"\";\r\n");
      out.write("\r\n");
      out.write("    }\r\n");
      ...
      out.write("                    layer.msg(\"删除成功！\",{time:1000,icon:6,shift:5},function () {\r\n");
      out.write("                        $(element).parents(\"tr\").remove()\r\n");
      out.write("                    })\r\n");
      out.write("                }else{\r\n");
      out.write("                    layer.msg(\"删除失败，请联系管理员！\",{time:1500,icon:5,shift:6},function () {\r\n");
      out.write("\r\n");
      out.write("                    })\r\n");
      out.write("                }\r\n");
      out.write("            },error : function () {\r\n");
      ...
      out.write("        //批量删除\r\n");
      out.write("        var array = []\r\n");
      out.write("        var allCheckBoxes = $(\"#userInfo :checkbox\")\r\n");
      out.write("        $(allCheckBoxes).each(function (index,element) {\r\n");
      out.write("            if(element.checked){\r\n");
      out.write("                array.push(element.value)\r\n");
      out.write("            }\r\n");
      out.write("        })\r\n");
      out.write("        if(array.length == 0){\r\n");
      out.write("            //一个也没选\r\n");
      out.write("            layer.msg(\"请至少选中一个要删除的对象\",{time:1500,icon:5,shift:6},function () {\r\n");
      out.write("\r\n");
      out.write("            })\r\n");
      out.write("        }else{\r\n");
      out.write("            //至少选中一个\r\n");
